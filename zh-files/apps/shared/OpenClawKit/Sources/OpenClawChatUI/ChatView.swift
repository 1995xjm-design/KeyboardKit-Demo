...
public struct OpenClawChatView: View {
        ...
        for error: String) -> (title: String, message: String, systemImage: String, tint: Color)
    {
        ...
        if lower.contains("not connected") || lower.contains("socket") {
            return (String(localized: "Disconnected"), String(localized: "Reconnect to your gateway to continue."), "wifi.slash", .orange)
        }
        if lower.contains("timed out") {
            return (String(localized: "Timed out"), String(localized: "The gateway took too long to respond."), "clock.badge.exclamationmark", .orange)
        }
