...
#if DEBUG
#Preview(String(localized: "Quick setup gateway"), traits: .fixedLayout(width: 393, height: 520)) {
    GatewayQuickSetupPreviewHost(hasGateway: true)
}

#Preview(String(localized: "Quick setup searching"), traits: .fixedLayout(width: 393, height: 520)) {
...
private struct GatewayQuickSetupPreviewHost: View {
    ...
    init(hasGateway: Bool) {
        ...
        if hasGateway {
            ...
            appModel.gatewayStatusText = String(localized: "Ready to pair")
        }
...
extension GatewayDiscoveryModel.DiscoveredGateway {
    fileprivate static let previewGateway = GatewayDiscoveryModel.DiscoveredGateway(
        name: String(localized: "Studio Gateway"),
        endpoint: .hostPort(
