        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    self.activityCard(
                        gatewayTitle: "Gateway",
                        gatewayDetail: String(localized: "No gateway connection"),
        ...
        ProCard(padding: 0, radius: OpenClawProMetric.cardRadius) {
            VStack(spacing: 0) {
                ...
                ProStatusRow(
                    ...
                    title: "Share intake",
                    detail: String(localized: "No share events yet."),
                    value: "iPad",
                    color: OpenClawBrand.accent,
                    actionTitle: nil,
                    action: nil)
                ...
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    ProCard(padding: 0, radius: OpenClawProMetric.cardRadius) {
                        ProStatusRow(
                            ...
                            title: String(localized: "Loading cards"),
                            detail: String(localized: "Refreshing the workboard from the gateway."),
                            value: "loading",
                            color: OpenClawBrand.accent,
                            actionTitle: nil,
                            action: nil)
                    ...
                    ProCard(padding: 0, radius: OpenClawProMetric.cardRadius) {
                        ProStatusRow(
                            ...
                            title: String(localized: "Cards unavailable"),
                            detail: String(localized: "Check the gateway connection, then refresh."),
                            value: "error",
                            color: OpenClawBrand.warn,
                            actionTitle: "Retry",
                            action: {})
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    ProCard(radius: OpenClawProMetric.cardRadius) {
                        ProStatusRow(
                            icon: "wifi.slash",
                            title: String(localized: "Workshop offline"),
                            detail: String(localized: "Connect to the gateway to load Skill Workshop proposals."),
                            value: "offline",
                            color: .secondary,
                            actionTitle: nil,
                            action: nil)
