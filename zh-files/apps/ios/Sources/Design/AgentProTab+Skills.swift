...
extension AgentProTab {
    ...
    var skillPolicySummary: String {
        ...
        if filter.isEmpty {
            return String(localized: "No skills are allowed for this agent.")
        }
    ...
    func patchAgentSkills(_ skills: [String]?, busyKey: String) async {
        ...
        do {
            ...
            {
                skillMutationStatusText = String(localized: "This agent already inherits the default skill policy.")
                return
            }
    ...
    static func skillMutationMessage(_ error: Error) -> String {
        if let gatewayError = error as? GatewayResponseError {
            ...
            if lower.contains("operator.admin") || lower.contains("unauthorized") {
                return String(localized: "This gateway connection cannot edit config yet. Reconnect with admin scope.")
            }
