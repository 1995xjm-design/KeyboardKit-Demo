...
extension AgentOverviewSnapshot {
    static var screenshotFixture: AgentOverviewSnapshot {
        ...
        let daily = CronJob(
            id: "release-briefing",
            name: String(localized: "Release briefing"),
            description: String(localized: "Summarize mobile release readiness and open risks."),
            enabled: true,
            ...
            payload: AnyCodable([
                ...
                "message": AnyCodable(String(localized: "Summarize mobile release readiness and open risks.")),
        ...
        let weekly = CronJob(
            ...
            name: String(localized: "Weekly project review"),
...
enum SkillMutationError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .liveGatewayUnavailable:
            String(localized: "Connect a live gateway to edit agent skills.")
        case .missingConfigHash:
