...
struct SettingsSkillsDestination: View {
    ...
    private static var screenshotSkills: [SkillStatus] {
        [
            SkillStatus(
                name: "github",
                description: String(localized: "Review pull requests, issues, checks, and repository activity."),
                source: "managed",
                bundled: true,
            ...
            SkillStatus(
                name: "calendar",
                description: String(localized: "Plan meetings and turn your schedule into focused daily briefs."),
                source: "managed",
                bundled: false,
            ...
            SkillStatus(
                ...
                description: String(localized: "Create and edit images from a clear visual brief."),
                source: "managed",
                bundled: false,
