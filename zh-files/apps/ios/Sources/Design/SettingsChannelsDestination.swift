...
struct SettingsChannelsDestination: View {
    ...
    private func entry(channelID: String, snapshot: ChannelsStatusResult) -> SettingsChannelEntry {
        ...
        return SettingsChannelEntry(
            ...
            lastError: lastError,
            unavailableReason: configured ? nil : String(localized: "Configure this channel on the gateway."),
            accounts: accounts)
    }
...
private struct SettingsChannelsStatesPreview: View {
    ...
    private static let telegramEntry = SettingsChannelEntry(
        id: "telegram",
        label: "Telegram",
        detail: String(localized: "Message routing client"),
        ...
        accounts: [
            SettingsChannelAccount(
                id: "main",
                name: String(localized: "OpenClaw Ops"),
                configured: true,
                enabled: true,
                running: true,
                connected: true,
