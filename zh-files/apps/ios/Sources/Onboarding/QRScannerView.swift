...
struct QRScannerView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIViewController {
        guard DataScannerViewController.isSupported else {
            context.coordinator.reportError(String(localized: "QR scanning is not supported on this device."))
            return UIViewController()
        }
        guard DataScannerViewController.isAvailable else {
            context.coordinator.reportError(String(localized: "Camera scanning is currently unavailable."))
            return UIViewController()
        }
    ...
    final class QRScannerContainerViewController: UIViewController {
        ...
        private func startScanningIfNeeded() {
            ...
            do {
                ...
                self.coordinator.reportError(String(localized: "Could not start QR scanner."))
            }
        }
    }
    ...
    final class Coordinator: NSObject, DataScannerViewControllerDelegate {
        ...
        {
            self.reportError(String(localized: "Camera is not available on this device."))
        }
    }
}