...
enum ScreenshotFixtureMode {
    static let gatewayName = String(localized: "OpenClaw Gateway")
...
struct LocalChatFixture {
    ...
    static let appleReviewDemo = LocalChatFixture(
        ...
        responsePrefix: String(localized: "Demo mode is active."),
        seedMessages: [
            """
    ...
    static let appScreenshots = LocalChatFixture(
        ...
        responsePrefix: String(localized: "OpenClaw is connected to your gateway."),
